...
function (_React$Component) {
  ...
  function Textarea() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "minHeight", 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "expandTextarea", function () {
