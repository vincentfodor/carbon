...
function (_React$Component) {
  ...
  function Tab() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setValidity", function (valid) {
      _this.context.tabs.changeValidity(_this.props.tabId, valid);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setWarning", function (warning) {
