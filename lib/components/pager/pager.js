...
function (_React$Component) {
  ...
  function Pager() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleCurrentPageInputChange", function (ev) {
      _this.setState({
        currentPage: ev.target.value
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleCurrentPageKeyUp", function (ev) {
      if (_events.default.isEnterKey(ev)) {
        _this.emitChangeCallback('input', ev);
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "emitChangeCallback", function (element, ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "emitCallbackSelector", function (element) {
      return function (ev) {
