...
function (_React$Component) {
  ...
  function ActionToolbar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleOnClick", function (onClick, selected) {
      if (!onClick) {
        return null;
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "propsForChildren", function () {
      return {
    ...
    _this.actions = _this.actions.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.buildAction = _this.buildAction.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
