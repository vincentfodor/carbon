...
function (_React$Component) {
  ...
  function Flash(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dialogs", []);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "timeout", null);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startTimeout", function () {
      _this.stopTimeout();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "shouldStartTimeout", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleDialog", function (key) {
      return function (ev) {
        if (ev) {
          ev.preventDefault();
        }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "formatDescription", function (description) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "findMore", function (text) {
      var value = text;
