...
function (_TableHeader) {
  ...
  function TableSubheader() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TableSubheader).apply(this, arguments));
  }
  ...
  _createClass(TableSubheader, [{
    ...
    value: function tableHeaderClasses() {
      return (0, _classnames.default)('carbon-table-subheader', _get(_getPrototypeOf(TableSubheader.prototype), "tableHeaderClasses", this).call(this));
    }
  }, {
    key: "componentTags",
