...
function (_React$Component) {
  ...
  function TableRow() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSelectAll", function () {
      _this.context.selectAll(_assertThisInitialized(_assertThisInitialized(_this)));
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onRowClick", function () {
      if (_this.props.onHighlight) {
        // trigger onHighlight callback if defined
        _this.props.onHighlight(_this.props.uniqueID, !_this.state.highlighted, _assertThisInitialized(_assertThisInitialized(_this)));
      } else {
        // trigger highlightRow method on the table
        _this.context.highlightRow(_this.props.uniqueID, _assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSelect", function (ev) {
      if (_this.props.onSelect) {
        // trigger onSelect callback if defined
        _this.props.onSelect(_this.props.uniqueID, ev.target.value, _assertThisInitialized(_assertThisInitialized(_this)));
      } else {
        // trigger selectRow method on the table
        _this.context.selectRow(_this.props.uniqueID, _assertThisInitialized(_assertThisInitialized(_this)), !_this.state.selected);
      }
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "draggingIsOccurring", function () {
      return typeof _this.context.dragAndDropActiveIndex === 'number';
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDraggableCell", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderDraggableRow", function (row) {
      if (!_this.context.dragDropManager || _this.isHeader) {
        return row;
      }
