...
function (_React$Component) {
  ...
  function WithDrop() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(WithDrop).apply(this, arguments));
  }
...
_defineProperty(WithDrop, "propTypes", {
  ...
  canDrop: _propTypes.default.func // an optional callback to determine if this item can be dropped on
...
_itemTypes.default.getItemType, ItemTarget, function (connect) {
  return {
