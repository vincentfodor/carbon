...
function (_React$Component) {
  ...
  function DraggableContext(_props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleHover", _itemTarget.default.onHoverUpDown);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "checkAutoScroll", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startScrolling", function () {
      if (!_this.frame) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "tick", function () {
      ...
      if (!_this.element) {
        var node = _reactDom.default.findDOMNode(_assertThisInitialized(_assertThisInitialized(_this))); // eslint-disable-line  react/no-find-dom-node
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDrag", function (originalIndex, hoverIndex) {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleBeginDrag", function (props) {
      return _objectSpread({
        index: props.index
      }, props);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleEndDrag", function () {
