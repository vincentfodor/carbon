...
var CustomDragLayer = function (_React$Component) {
  ...
  function CustomDragLayer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CustomDragLayer.__proto__ || Object.getPrototypeOf(CustomDragLayer)).call.apply(_ref, [this].concat(args))), _this), _this.getClassName = function (props) {
      return (0, _classnames2.default)('custom-drag-layer', props.className);
    }, _this.createClonedChild = function (props) {
      if (_this._container) {
