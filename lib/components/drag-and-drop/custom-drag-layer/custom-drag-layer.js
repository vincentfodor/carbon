...
function (_React$Component) {
  ...
  function CustomDragLayer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getClassName", function (props) {
      return (0, _classnames.default)('custom-drag-layer', props.className);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "createClonedChild", function (props) {
      if (_this._container) {
