...
function (_React$Component) {
  ...
  function ConfigurableItems() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "additionalActions", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "rows", function () {
