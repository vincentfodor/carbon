...
function (_React$Component) {
  ...
  function ConfigurableItemRow() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "classes", function (dragAndDropActiveIndex, index) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "listItemHTML", function () {
