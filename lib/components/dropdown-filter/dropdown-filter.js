...
function (_Dropdown) {
  ...
  function DropdownFilter() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleCreate", function (ev) {
      _this.setState({
        open: false
      });

      _this.props.create(ev, _assertThisInitialized(_assertThisInitialized(_this)));
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "prepareList", function (options) {
      var filteredOptions;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "highlighted", function (options) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "highlightMatches", function (optionText, value) {
      if (!value.length) {
        return optionText;
      }
    ...
    _this.handleVisibleChange = _this.handleVisibleChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
