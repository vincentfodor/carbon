...
function (_React$Component) {
  ...
  function Step() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleOnNext", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleOnBack", function (ev) {
