...
function (_React$Component) {
  ...
  function Detail() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "icon", function () {
      if (!_this.props.icon) {
        return null;
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "footnote", function () {
