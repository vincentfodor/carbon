...
function (_React$Component) {
  ...
  function ShowEditPod() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onEdit", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSaveEditForm", function (ev, valid) {
      ev.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onCancelEditForm", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "control", 'props');

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "__focusOnPod", function () {
