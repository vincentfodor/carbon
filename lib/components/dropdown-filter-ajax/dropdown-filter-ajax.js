...
function (_DropdownFilter) {
  ...
  function DropdownFilterAjax() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getData", function () {
      ...
      _this.pendingRequest = _superagent.default.get(_this.props.path).query(_this.getParams(query, page)).query(_this.props.additionalRequestParams).set('Accept', _this.props.acceptHeader);
      if (_this.props.withCredentials) _this.pendingRequest.withCredentials();

      _this.pendingRequest.end(_this.ajaxUpdateList);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getParams", function (query, page) {
      var params = {};
      params.page = page;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "ajaxUpdateList", function (err, response) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateList", function (data) {
