...
var DropdownFilterAjax = function (_DropdownFilter) {
  ...
  function DropdownFilterAjax() {
    ...
    _this.getData = function () {
      ...
      _this.pendingRequest = _superagent2.default.get(_this.props.path).query(_this.getParams(query, page)).query(_this.props.additionalRequestParams).set('Accept', _this.props.acceptHeader).end(_this.ajaxUpdateList);
    };
...
DropdownFilterAjax.propTypes = (0, _lodash.omit)((0, _lodash.assign)({}, _dropdownFilter2.default.propTypes, {
   ...
   * @type {Number}
   */
  dataRequestTimeout: _propTypes2.default.number
}), 'options');
