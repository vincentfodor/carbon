...
var DropdownFilterAjax = function (_DropdownFilter) {
  ...
  function DropdownFilterAjax() {
    ...
    _this.getData = function () {
      ...
      _superagent2.default.get(_this.props.path).query(_this.getParams(query, page)).query(_this.props.additionalRequestParams).set('Accept', _this.props.acceptHeader).end(_this.ajaxUpdateList);
    };
