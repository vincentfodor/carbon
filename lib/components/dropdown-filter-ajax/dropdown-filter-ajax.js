...
var DropdownFilterAjax = function (_DropdownFilter) {
  ...
  function DropdownFilterAjax() {
    ...
    _this.getData = function () {
      ...
      var request = _superagent2.default.get(_this.props.path).query(_this.getParams(query, page)).query(_this.props.additionalRequestParams).set('Accept', _this.props.acceptHeader);

      if (_this.props.withCredentials) request.withCredentials();
      request.end(_this.ajaxUpdateList);
    };

    _this.getParams = function (query, page) {
      var params = {};
      params.page = page;
...
DropdownFilterAjax.propTypes = (0, _lodash.omit)((0, _lodash.assign)({}, _dropdownFilter2.default.propTypes, {
   ...
   * @type {String}
   */
  acceptHeader: _propTypes2.default.string,
