...
function (_Modal) {
  ...
  function Dialog(args) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "centerDialog", function (animating) {
      if (!_this._dialog) {
        return;
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "applyFixedBottom", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "shouldHaveFixedBottom", function () {
    ...
    _this.componentTags = _this.componentTags.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onDialogBlur = _this.onDialogBlur.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onCloseIconBlur = _this.onCloseIconBlur.bind(_assertThisInitialized(_assertThisInitialized(_this)));
