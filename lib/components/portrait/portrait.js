...
function (_React$Component) {
  ...
  function Portrait() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "memoizeInitials", null);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "applyBackground", function (context, size) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "applyText", function (context, size) {
