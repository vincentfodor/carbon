...
require("./fonts/carbon-icons-webfont.woff");
...
function (_React$Component) {
  ...
  function Icon() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_target", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "tooltipHTML", void 0);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "iconSvgHTML", function () {
