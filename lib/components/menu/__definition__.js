...
var _definition__ = require('./menu-item/__definition__');

var _definition__2 = _interopRequireDefault(_definition__);

var _definition__3 = require('./submenu-block/__definition__');
...
var definition = new _definition2.default('menu', _.Menu, {
  ...
  associatedDefinitions: [_definition__2.default, _definition__4.default],
  propOptions: {
