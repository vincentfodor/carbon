...
function (_React$Component) {
  ...
  function Pill() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "mainClasses", function () {
      return (0, _classnames.default)('carbon-pill', _this.props.className, "carbon-pill--".concat(_this.props.as).concat(_this.props.fill ? '--fill' : '--empty'), {
        'carbon-pill--link': _this.props.onClick
      });
    });
  ...
  _createClass(Pill, [{
    ...
    value: function render() {
      ...
      }, (0, _tags.default)('pill', this.props)), this.props.children);
    }
  }]);
