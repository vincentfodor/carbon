...
function (_React$Component) {
  ...
  function SplitButton(args) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showButtons", function () {
      _this.setState({
        showAdditionalButtons: true
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "hideButtons", function () {
      _this.setState({
        showAdditionalButtons: false
      });
    });
