...
function (_React$Component) {
  ...
  function Decimal() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "highlighted", false);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "verifiedPrecision", function (precision) {
      if (precision > 20) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isValidDecimal", function (value, precision) {
