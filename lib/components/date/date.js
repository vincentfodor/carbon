...
function (_React$Component) {
  ...
  function Date(args) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_document", document);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "datePickerValueChanged", function (prevProps) {
      return _this.blockBlur && _this.props.value && prevProps.value !== _this.props.value;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "emitOnChangeCallback", function (val) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "openDatePicker", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "closeDatePicker", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateVisibleValue", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleVisibleInputChange", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "monthOrYearHasChanged", function (newDate) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleWidgetClick", function (ev) {
      ev.nativeEvent.stopImmediatePropagation();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDateSelect", function (val, modifiers) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateDatePickerPosition", function () {
      _this.setState({
