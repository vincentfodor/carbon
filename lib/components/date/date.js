...
var Date = (0, _input2.default)((0, _inputIcon2.default)((0, _inputLabel2.default)((0, _inputValidation2.default)((_temp = _class = function (_React$Component) {
  ...
  function Date(args) {
    ...
    _this.emitOnChangeCallback = function (val) {
      ...
      hiddenField.value = _date2.default.formatDateString(val, _this.hiddenFormat());
    ...
    */
    ...
    get: function get() {
      ...
      return {
        ...
        fixedWeeks: true,
        initialMonth: this.state.datePickerValue || _date2.default.stringToDate(this.props.value),
        inline: true,
