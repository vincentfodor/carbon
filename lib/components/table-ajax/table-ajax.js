...
function (_Table) {
  ...
  function TableAjax() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "timeout", null);

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_request", null);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "emitOnChangeCallback", function (element, options) {
      ...
      _this.timeout = setTimeout(function () {
        ...
        _this._request = _superagent.default.get(_this.props.path).set(_this.getHeaders()).query(_this.queryParams(element, options)).end(function (err, response) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "stopTimeout", function () {
      if (_this.timeout) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleResponse", function (err, response) {
      if (!err) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "queryParams", function (element, options) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getHeaders", function () {
