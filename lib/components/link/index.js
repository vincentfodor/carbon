...
function (_React$Component) {
  ...
  function _Link() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(_Link)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(_Link, [{
    ...
    value: function render() {
      return React.createElement(this.linkType.component, this.componentProps, React.createElement("span", null, this.iconLeft, React.createElement("span", {
    ...
    key: "componentProps",
    get: function get() {
      var _validProps = (0, _ether.validProps)(this, _reactRouter.Link.defaultProps),
