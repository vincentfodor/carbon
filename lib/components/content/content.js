...
function (_React$Component) {
  ...
  function Content(args) {
    ...
    _this.titleStyle = _this.titleStyle.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.bodyStyle = _this.bodyStyle.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.classes = _this.classes.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  /**
