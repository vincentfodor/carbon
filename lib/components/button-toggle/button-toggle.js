...
var ButtonToggle = (0, _input2.default)((_temp = _class = function (_React$Component) {
  ...
  _createClass(ButtonToggle, [{
     ...
     */
    get: function get() {
      return (0, _classnames2.default)('carbon-button-toggle', 'carbon-button-toggle--' + this.props.size, { 'carbon-button-toggle--grouped': this.props.grouped });
    }
...
}, _class.safeProps = ['name'], _class.defaultProps = {
  size: 'large' }, _temp));
