...
function (_React$Component) {
  ...
  function GroupedCharacter() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "adjustForSeparator", function (leftPosition) {
      return _this.isBackspaceKey() ? leftPosition : _this.lastPosition + 1;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "calculateMaxLength", function () {
      return (0, _lodash.sum)(_this.props.groups) + (_this.props.groups.length - 1);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "deleteAfterSeparator", function (value) {
      var upToSeparator = _this.sliceUpToSeparator();

      return value.slice(0, upToSeparator) + value.slice(upToSeparator + 1);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "deletingBeforeSeparator", function () {
      return _this.isDeleteKey() && (0, _lodash.includes)(_this.insertionIndices, _this.lastPosition);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "enforceMaxLength", function (value) {
      return value.slice(0, _this.maxLength);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "insertionIndices", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isValidKeypress", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "removeSeparators", function (value) {
      return value.replace(/\W/g, '');
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "separatorsNotNeeded", function (plainValue) {
      return plainValue.length < _this.insertionIndices[0];
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setVisibleValue", function (plainValue) {
    ...
    _this.getNewPosition = _this.getNewPosition.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.sliceUpToSeparator = _this.sliceUpToSeparator.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getPlainValue = _this.getPlainValue.bind(_assertThisInitialized(_assertThisInitialized(_this))); // value without separators
