...
function (_React$Component) {
  ...
  function Carousel() {
    ...
    _this.mainClasses = _this.mainClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onPreviousClick = _this.onPreviousClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onNextClick = _this.onNextClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onSlideSelection = _this.onSlideSelection.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.enableButtonsAfterTimeout = _this.enableButtonsAfterTimeout.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.previousButtonProps = _this.previousButtonProps.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.nextButtonProps = _this.nextButtonProps.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.numOfSlides = _this.numOfSlides.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.visibleSlide = _this.visibleSlide.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.slideSelector = _this.slideSelector.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.nextClasses = _this.nextClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.previousClasses = _this.previousClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.previousButtonClasses = _this.previousButtonClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.nextButtonClasses = _this.nextButtonClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.slideSelectorClasses = _this.slideSelectorClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.transitionName = _this.transitionName.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
