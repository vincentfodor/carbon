...
function (_React$Component) {
  ...
  function Pod() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "linkProps", function () {
      var props = {
        'data-element': 'edit'
      };
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "processPodEditEvent", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleHoverState", function (val) {
      _this.setState({
        hoverEdit: val
      });
    });
