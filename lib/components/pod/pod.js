...
var Pod = function (_React$Component) {
  ...
  function Pod() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Pod.__proto__ || Object.getPrototypeOf(Pod)).call.apply(_ref, [this].concat(args))), _this), _this.toggleCollapse = function () {
  ...
  _createClass(Pod, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({
          className: this.mainClasses }, props, (0, _tags2.default)('pod', this.props)),
