...
function (_React$Component) {
  ...
  function AnimatedMenuButton() {
    ...
    _this.closeIcon = _this.closeIcon.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.componentProps = _this.componentProps.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleBlur = _this.handleBlur.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.innerHTML = _this.innerHTML.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.labelHTML = _this.labelHTML.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.mainClasses = _this.mainClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.openHandler = _this.openHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
