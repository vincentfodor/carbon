...
function (_React$Component) {
  ...
  function MenuList() {
    ...
    _this.filterHTML = _this.filterHTML.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.mainClasses = _this.mainClasses.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.menuItems = _this.menuItems.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.menuTitle = _this.menuTitle.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onSearch = _this.onSearch.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.showMenuItems = _this.showMenuItems.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.toggleChildren = _this.toggleChildren.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
