...
var definition = new _definition.default('message', _.default, {
  ...
  propDescriptions: {
    as: "Sets the theme of the notification. Possible values include: ".concat(_optionsHelper.default.colors.join(', ')),
