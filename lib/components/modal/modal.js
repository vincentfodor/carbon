...
function (_React$Component) {
  ...
  function Modal(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateDataState", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "closeModal", function (ev) {
  ...
  _createClass(Modal, [{
    ...
    value: function componentDidUpdate() {
      var _window = _browser.default.getWindow();
