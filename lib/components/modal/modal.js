...
var Modal = function (_React$Component) {
  ...
  function Modal(props) {
    ...
    _this.closeModal = function (ev) {
      if (_this.props.open && _this.props.onCancel && !_this.props.disableEscKey && _events2.default.isEscKey(ev)) {
  ...
  _createClass(Modal, [{
    ...
    value: function componentDidMount() {
      _browser2.default.getWindow().addEventListener('keyup', this.closeModal);
    }
    ...
    value: function componentWillUnmount() {
      _browser2.default.getWindow().removeEventListener('keyup', this.closeModal);
    }
