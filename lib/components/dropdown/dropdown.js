...
var Dropdown = (0, _input2.default)((0, _inputIcon2.default)((0, _inputLabel2.default)((0, _inputValidation2.default)((_temp = _class = function (_React$Component) {
  ...
  function Dropdown() {
    ...
    _this.calculatePosition = function () {
      ...
      var top = inputBoundingRect.top + inputBoundingRect.height + window.pageYOffset + 'px';
      var width = inputBoundingRect.width + 'px';
      var left = inputBoundingRect.left + 'px';
      _this.listBlock.setAttribute('style', 'left: ' + left + '; top: ' + top + '; width: ' + width + ';');
    };
  ...
  _createClass(Dropdown, [{
    ...
    get: function get() {
      return {
        ...
        className: (0, _classnames2.default)('carbon-dropdown__list-block')
      };
    }
