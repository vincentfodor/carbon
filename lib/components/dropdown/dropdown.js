...
function (_React$Component) {
  ...
  function Dropdown() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "emitOnChangeCallback", function (value, visibleValue) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSelect", function (ev) {
      _this.selectValue(ev.currentTarget.getAttribute('value'), ev.currentTarget.textContent);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseOverListItem", function (ev) {
      _this.setState({
        highlighted: ev.currentTarget.getAttribute('value')
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseEnterList", function () {
      _this.blockBlur = true;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseLeaveList", function () {
      _this.blockBlur = false;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMouseDownOnList", function (ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleTouchEvent", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "nameByID", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleKeyDown", function (ev) {
      ev.stopPropagation();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onUpArrow", function (list, element) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDownArrow", function (list, element) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "highlighted", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "calculatePosition", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "requestingState", function () {});
    ...
    _this.results = _this.results.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
