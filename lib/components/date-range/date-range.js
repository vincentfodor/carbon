...
function (_React$Component) {
  ...
  function DateRange() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_onChange", function (changedDate, ev) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "focusStart", function () {
      _this._endDate.closeDatePicker();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "focusEnd", function () {
