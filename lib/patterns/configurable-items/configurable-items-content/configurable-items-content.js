...
function (_React$Component) {
  ...
  function ConfigurableItemsContent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (rowId) {
      return function () {
        _this.props.onChange(rowId);
      };
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "rows", function (itemsData) {
