...
function (_React$Component) {
  ...
  function ConfigurableItemsPattern() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onChange", function (rowIndex) {
      _actions.default.updateItem(rowIndex);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDrag", function (dragIndex, hoverIndex) {
      _actions.default.reorderItems(dragIndex, hoverIndex);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onReset", function (event) {
      _actions.default.toggleDialogOpen();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSave", function (event) {
