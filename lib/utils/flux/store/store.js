...
function (_EventEmitter) {
  ...
  function Store(name, data) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addChangeListener", function (callback) {
      _this.on(CHANGE_EVENT, callback);
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "removeChangeListener", function (callback) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dispatcherCallback", function (action) {
      ...
      if (_this[action.actionType]) {
        ...
        _this[action.actionType].call(_assertThisInitialized(_assertThisInitialized(_this)), action); // tell the store a change has occurred
    ...
    var dispatcher = opts.dispatcher || _.Dispatcher;
    /**
