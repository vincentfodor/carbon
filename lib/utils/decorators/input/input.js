...
var Input = function Input(ComposedComponent) {
  ...
  function (_ComposedComponent) {
    ...
    function Component() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleOnChange", function (ev) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleDeferred", function (ev) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setTextIndentation", function () {
        if (_this._input) {
          if (_this._prefix) {
