...
var InputIcon = function InputIcon(ComposedComponent) {
  var Component = function (_ComposedComponent) {
    ...
    function Component() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Component.__proto__ || Object.getPrototypeOf(Component)).call.apply(_ref, [this].concat(args))), _this), _this.inputIconHTML = function (iconType) {
