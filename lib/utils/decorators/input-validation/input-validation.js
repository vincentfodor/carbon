...
var InputValidation = function InputValidation(ComposedComponent) {
  ...
  function (_ComposedComponent) {
    ...
    function Component() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "positionMessage", function () {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "info", function () {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateInfo", function (valid, value, info) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "warning", function () {
        var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.props.value;
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateWarning", function (valid, value, warning) {
        // if validation fails
        if (!valid) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "updateValidation", function (valid, value, validation) {
        // if validation fails
        if (!valid) {
          // if input currently thinks it is valid
        ...
        if (!_this.state.valid || _this.state.warning || _this.state.info) {
          ...
          if (!_this.state.messageLocked) {
            if (_this.context.form) {
              _this.context.form.setActiveInput(_assertThisInitialized(_assertThisInitialized(_this)));
            }
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleContentChange", function () {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "resetTab", function () {
        if (!_this.state.valid) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "messageExists", function () {
        return !_this.state.valid || _this.state.warning || _this.state.info;
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showMessage", function () {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "hideMessage", function () {
        if (_this.messageExists()) {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_isCurrentlyActiveInput", function () {
        return _this.context.form && _this.context.form.getActiveInput() === _assertThisInitialized(_assertThisInitialized(_this));
      });

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_validations", function () {
