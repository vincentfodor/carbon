...
var TooltipDecorator = function TooltipDecorator(ComposedComponent) {
  var Component = function (_ComposedComponent) {
    ...
    function Component() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Component.__proto__ || Object.getPrototypeOf(Component)).call.apply(_ref, [this].concat(args))), _this), _this._tooltipTimeout = null, _this._memoizedShifts = null, _this.state = {
        /**
        ...
        return _reactDom2.default.findDOMNode(_this._target); // eslint-disable-line react/no-find-dom-node
      }, _this.getTooltip = function () {
        return _reactDom2.default.findDOMNode(_this._tooltip); // eslint-disable-line react/no-find-dom-node
    ...
    _createClass(Component, [{
      ...
      get: function get() {
        ...
        return this.props.tooltipMessage && this.state.isVisible && _react2.default.createElement(
          _portal2.default,
          { key: 'tooltip' },
  ...
  Component.propTypes = (0, _lodash.assign)({}, ComposedComponent.propTypes, {
     ...
     * @type {Node}
     */
    tooltipMessage: _propTypes2.default.node,
