...
var TooltipDecorator = function TooltipDecorator(ComposedComponent) {
  ...
  function (_ComposedComponent) {
    ...
    function Component() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_tooltipTimeout", null);

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_memoizedShifts", null);
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onShow", function () {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onHide", function () {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "calculatePosition", function (tooltip, target) {
