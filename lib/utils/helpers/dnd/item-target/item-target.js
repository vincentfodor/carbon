...
var ItemTargetHelper = {
  ...
  onHoverUpDown: function onHoverUpDown(props, monitor, component) {
    ...
    var el = _reactDom.default.findDOMNode(component); // eslint-disable-line react/no-find-dom-node


    var hoverBoundingRect = el.getBoundingClientRect(); // Get vertical middle
