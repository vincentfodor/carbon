 ...
 */
var _default = function _default(queryOptions, functions, options) {
  ...
  var opts = getOptions(options); // pollCount for use if retries option passed
  ...
  (function poll() {
    ...
    _superagent.default.get(queryOpts.url).query(queryOpts.data).set(queryOpts.headers).end(function (err, response) {
      var result;
...
function getFunctions(functions) {
  return {
    ...
    onMaxRetries: functions.onMaxRetries || function () {
