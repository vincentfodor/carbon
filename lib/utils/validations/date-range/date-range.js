...
function DateRangeValidator() {
  ...
  _defineProperty(this, "message", function () {
    return _validations.default.validationMessage(_this.messageText);
  });

  _defineProperty(this, "compareDates", function (start, end) {
  ...
  _defineProperty(this, "bothDatesValid", function (date1, date2) {
    return _date.default.isValidDate(date1) && _date.default.isValidDate(date2);
  });
...
var _default = DateRangeValidator;
