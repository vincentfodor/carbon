...
var NumeralTypeValidator = function NumeralTypeValidator() {
  ...
  var validationToCall = "validate".concat(numeralType);
...
function validateDecimal() {
  return {
    ...
    message: function message() {
      return _validations.default.validationMessage(this.customMessage, 'errors.messages.not_a_number');
    }
  };
}
/**
...
function validateInteger() {
  return {
     ...
     */
    message: function message() {
      return _validations.default.validationMessage(this.customMessage, 'errors.messages.not_an_integer');
    }
  };
}