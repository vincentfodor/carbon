...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    key: 'get',
    value: function get(id, onSuccess, onError) {
      this.client.get(String(id)).then(this.handleResponse.bind(this, onSuccess), this.handleResponse.bind(this, onError));
    }
    ...
    key: 'post',
    value: function post(data, onSuccess, onError) {
      this.client.post('', data).then(this.handleResponse.bind(this, onSuccess), this.handleResponse.bind(this, onError));
    }
    ...
    key: 'put',
    value: function put(id, data, onSuccess, onError) {
      this.client.put(String(id), data).then(this.handleResponse.bind(this, onSuccess), this.handleResponse.bind(this, onError));
    }
    ...
    key: 'delete',
    value: function _delete(id, onSuccess, onError) {
      this.client.delete(String(id)).then(this.handleResponse.bind(this, onSuccess), this.handleResponse.bind(this, onError));
    }
